...
This helps identify where to continue interrupted updates.
"""
...
def check_recent_modifications():
    ...
    # Files likely updated for current architecture (single root frontend)
    likely_files = [
    ...
    if os.path.exists("config/bot_config.py"):
        with open("config/bot_config.py", "r", encoding="utf-8") as f:
