...
class CycleOrchestrator:
    ...
    def _analyze_and_trade(
        ...
        """
        Analyze each coin and execute trades.
        Priorità assoluta: coin con posizione aperta devono essere sempre analizzate ad ogni ciclo.
        Il cap max_trades_per_cycle blocca solo nuove coin senza posizione.
        """
        ...
        for coin in open_position_coins + self.trading_pairs:
